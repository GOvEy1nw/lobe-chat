...
import { Form, type FormItemProps, Icon, type ItemGroup, Tooltip } from '@govey1nw/lobehub-ui';
...
const EmojiPicker = dynamic(() => import('@govey1nw/lobehub-ui/es/EmojiPicker'), { ssr: false });
